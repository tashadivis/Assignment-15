...
- Created a reservation form widget.

**Version 1.3.0**

- Improved the base code for creating reservations.

**Version 1.2.9**

- The taxonomies can now be view in the blog role for menu, course, diet and cuisine.

**Version 1.2.8**

- Fixed an error message about the image dimensions for the restaurant menu shortcode.
...
- Updates to the email notifications screen.
- Added template tag instructions to the screen.
- Enabled template tags for the email subject.
- Improved the reservation screen for better output messages when saving.
- Improved the styling for the dropdown time selector on the menu.
- Enabled menu item images to be displayed on the menu item shortcode.

**Version 1.2.5**

- Major update to the reservations manager list.  Improved notifications styling and new buttons.
- A short version of the notes is now displayed with a link to a larger set of notes.

**Version 1.2.4**

- Updated the localization for any missing texts.
...
- Added localization to the events log.
- Improved the execution of the database tables when upgrading the plugin.

**Version 1.2.1**

- Fixed the upgrade message
...
- MailChimp subscriber list support when booking a table.
- Updated the AddOns page.
- Improved styling and menu functions.
